...
#how to write a csv file and open it in excel format
head(iris)
write.csv(iris, "./data/iris.csv", row.names=F)
read1 = read.csv(file="./data/iris.csv", header = TRUE,sep = ",")
read1
read1 = read.csv(file="./data/krishna.csv", header = TRUE,sep = ",")
...
url_gsheet = "https://docs.google.com/spreadsheets/d/18rZlfOTeh3jccJs6s0b5ciVjZ_6WDHJNON4Zd8isiHo/edit#gid=0"
