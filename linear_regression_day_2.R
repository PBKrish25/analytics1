...
omni$sales
residuals(fit2)
summary(residuals(fit2))#difference between actual and predicted values
summary(fit2)
...
#Assumptions
par(mfrow=c(2,2))#par is parameter, mfrow is multiple frames per row, here 2 rows, 2 columns
plot(fit2)
par(mfrow=c(1,1))

#to get the induvidual plots
